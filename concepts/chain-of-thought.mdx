...
In Pure Python, you can use the `indent`, `prompt` and `llm_settings` parameters of the [send_message](/api-reference/send-message) function to display the intermediary steps.
