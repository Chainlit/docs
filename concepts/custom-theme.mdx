...
<Note>If you started your Chainlit app with -w (file watcher), it will refresh every time you update the theme!</Note>

<Warning>As of now, both themes have to be specified.</Warning>
