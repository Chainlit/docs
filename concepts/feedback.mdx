...
To use human feedback, you first need to enable [data persistence](/cloud/persistence).
...
You can disable human feedback for specific a [Message](/api-reference/message) by passing `disable_human_feedback=True`.
