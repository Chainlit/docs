...
<Note>This example has extra dependencies, such as `google-search-results` and `faiss`. You might have to install them manually.</Note>

<Note>If you have trouble installing `faiss`, try `pip install faiss-cpu`.</Note>
