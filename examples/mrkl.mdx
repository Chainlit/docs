...
The main change is that we grouped all the instantiation logic in the `load` function and decorated it with [@langchain_factory](/api-reference/langchain-factory).
