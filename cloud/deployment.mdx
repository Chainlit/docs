...
<Note>
  ...
  https://forms.gle/uyKyZmmpVET95Wbx8{" "}
</Note>
...
DATABASE_URL=postgresql://<username>:<password>@<host>:<port><?pgbouncer=true if using pg-bouncer>
...
DATABASE_DIRECT_URL=postgresql://<username>:<password>@<host>:<port>
