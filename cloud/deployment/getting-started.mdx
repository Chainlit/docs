...
3. Pull the image
```shell
docker pull chainlit/chainlit-cloud.<version>
```
...
1. Tag the image:
```shell
docker tag chainlit/chainlit-cloud:<version> <region>-docker.pkg.dev/<project_id>/<artifactory_name>/chainlit-cloud:<version>
```

2. Push the image
```shell
docker push <region>-docker.pkg.dev/<project_id>/<artifactory_name>/chainlit-cloud:<version>
```
...
1. Tag the image:
```shell
docker tag chainlit/chainlit-cloud:<version> gcr.io/<project_id>/chainlit-cloud:<version>
```

2. Push the image:
```shell
docker push gcr.io/<project_id>/chainlit-cloud:<version>
```
...
1. Tag the image:
```shell
docker tag chainlit/chainlit-cloud:<version> <aws_account_id>.dkr.ecr.<region>.amazonaws.com/chainlit/chainlit-cloud:<version>
```

2. Push the image
```shell
docker push <aws_account_id>.dkr.ecr.<region>.amazonaws.com/chainlit/chainlit-cloud:<version>
```
