...
To use custom persistence, create your own `Client` that extends the [BaseDBClient](https://github.com/Chainlit/chainlit/blob/main/src/chainlit/client/base.py) class. For reference, check the [CloudDBClient](https://github.com/Chainlit/chainlit/blob/main/src/chainlit/client/cloud.py) and [LocalDBClient](https://github.com/Chainlit/chainlit/blob/main/src/chainlit/client/local.py) implementations.

Finally, modify your Chainlit app code to add a `client_factory` and provide your custom client.
