...
You will also get the full generation details (prompt, completion, tokens per second...) in your Literal AI dashboard, if your project is using [Literal AI](https://docs.getliteral.ai).
...
<Warning>
  ...
  integration like Embedchain, Haystack, Langchain or LlamaIndex. Both
  integrations would record the same generation and create duplicate steps in
  the UI.
</Warning>
