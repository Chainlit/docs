...
Create a file named `.env` in the same folder as your `app.py` file. Add your OpenAI API key in the `OPENAI_API_KEY` variable. You can optionally add your [Literal](https://cloud.getliteral.ai) API key in the `LITERAL_API_KEY`.
