...
<Note>
If you plan to use [on_chat_start](/api-reference/lifecycle-hooks/on-chat-start) to welcome users, you should set [show_readme_as_default](/backend/config/ui) to `false` in your Chainlit config to avoid flickering.
</Note>
