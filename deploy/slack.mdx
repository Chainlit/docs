...
If you are working locally, you will have to expose your local Chainlit app to the internet. You can use [ngrok](https://ngrok.com/) for this.
...
async def on_message(msg: cl.Message):
    ...
    await cl.Message(f"Received: {msg.content}").send()
```
...
You should now be able to mention the app in a channel or send a direct message to it.

<Frame caption="Sending a DM">
  <img src="/images/slack/dm.png" />
</Frame>

<Frame caption="Mention the Chainlit App">
  <img src="/images/slack/mention.png" />
</Frame>
