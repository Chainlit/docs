...
<ParamField path="indent" type="int" optional>
  Number of indents to add to the message in the UI.
</ParamField>
<ParamField path="is_error" type="bool" optional>
  Whether the message indicates an error.
</ParamField>
<ParamField path="final" type="bool" optional>
  Whether the message is the final answer (vs a chain of thought step).
</ParamField>
