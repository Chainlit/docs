...
In addition to standard translations, you can customize the names of front-end components, molecules, and organisms used within the UI. Each UI element is associated with a unique translation key in the translation files. By modifying these keys, you can personalize or localize the UI text according to your needs.
