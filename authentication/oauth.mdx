...
<Warning>
  ...
  set the `BASE_URL` environment variable. For instance, if you host your
  application at `https://mydomain.com`, `BASE_URL` should be set to
  `https://mydomain.com`.
</Warning>
...
The callback URL should be: `BASE_URL/auth/oauth/aws-cognito/callback`. If your Chainlit app is hosted at localhost:8000, you should use `http://localhost:8000/auth/oauth/aws-cognito/callback`.
