---
title: Debugging Prompts in Chainlit
---
...
That's where the `pen button` comes in. Clicking on it opens a prompt playground, allowing you to modify and iterate on the prompt as needed:
