---
title: Migrate to Chainlit v1.1.300rc0
---
...
Begin the migration by updating Chainlit to the latest release candidate version:

```bash
pip install --upgrade chainlit --pre
```

<Warning>
  Keep in mind that it is a pre-release. The documentation and cookbook may not
